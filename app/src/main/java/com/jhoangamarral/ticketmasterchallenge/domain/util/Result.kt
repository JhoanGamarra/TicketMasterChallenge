package com.jhoangamarral.ticketmasterchallenge.domain.util

import com.jhoangamarral.ticketmasterchallenge.domain.util.Result.Success
import com.jhoangamarral.ticketmasterchallenge.domain.util.Result.Error
